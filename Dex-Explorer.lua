...
local function main()
	...
	Explorer.StartDrag = function(offX,offY)
		...
		mouseEvent = input.InputChanged:Connect(function(input)
			if input.UserInputService == Enum.UserInputService.TouchTap then
				move()
			end
		end)

		releaseEvent = input.InputEnded:Connect(function(input)
			if input.UserInputService == Enum.UserInputService.MouseButton1 then
	...
	Explorer.NewListEntry = function(index)
		...
		newEntry.InputBegan:Connect(function(input)
			...
			if not node or selection.Map[node] or input.UserInputService ~= Enum.UserInputService.TouchTap then return end
		...
		newEntry.Indent.Expand.InputBegan:Connect(function(input)
			local node = tree[index + Explorer.Index]
			if not node or input.UserInputService ~= Enum.UserInputService.TouchTap then return end
...
local function main()
	...
	Properties.NewPropEntry = function(index)
		...
		nameFrame.Expand.InputBegan:Connect(function(input)
			local prop = viewList[index + Properties.Index]
			if not prop or input.UserInputService ~= Enum.UserInputService.TouchTap then return end
		...
		nameFrame.PropName.InputBegan:Connect(function(input)
			local prop = viewList[index + Properties.Index]
			if not prop then return end
			if input.UserInputService == Enum.UserInputService.TouchTap and not nameFrame.PropName.TextFits then
		...
		nameFrame.PropName.InputEnded:Connect(function(input)
			if input.UserInputService == Enum.UserInputService.TouchTap and Properties.FullNameFrameIndex == index then
		...
		valueFrame.SoundPreview.InputBegan:Connect(function(input)
			if input.UserInputService ~= Enum.UserInputService.MouseButton1 then return end
...
local function main()
	...
	Lib.ButtonAnim = function(button,data)
		...
		button.InputBegan:Connect(function(input)
			...
			if input.UserInputService == Enum.UserInputService.TouchTap and not holding then
				if mode == 1 then
					button.BackgroundTransparency = 0.4
				elseif mode == 2 then
					button.BackgroundColor3 = control.HoverColor
				end
			elseif input.UserInputService == Enum.UserInputService.MouseButton1 then
				holding = true
				if mode == 1 then
	...
	Lib.ScrollBar = (function()
		...
		local function createFrame(self)
			...
			button1.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and not buttonPress and self:CanScrollUp() then button1.BackgroundTransparency = 0.8 end
				if input.UserInputService ~= Enum.UserInputService.MouseButton1 or not self:CanScrollUp() then return end
				buttonPress = true
			...
			button1.InputEnded:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and not buttonPress then button1.BackgroundTransparency = 1 end
			end)
			button2.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and not buttonPress and self:CanScrollDown() then button2.BackgroundTransparency = 0.8 end
				if input.UserInputService ~= Enum.UserInputService.MouseButton1 or not self:CanScrollDown() then return end
				buttonPress = true
			...
			button2.InputEnded:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and not buttonPress then button2.BackgroundTransparency = 1 end
			end)

			scrollThumb.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and not thumbPress then scrollThumb.BackgroundTransparency = 0.2 scrollThumb.BackgroundColor3 = self.ThumbSelectColor end
				if input.UserInputService ~= Enum.UserInputService.MouseButton1 then return end
				...
				mouseEvent = user.InputChanged:Connect(function(input)
					if input.UserInputService == Enum.UserInputService.TouchTap and thumbPress and releaseEvent.Connected then
			...
			scrollThumb.InputEnded:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and not thumbPress then scrollThumb.BackgroundTransparency = 0 scrollThumb.BackgroundColor3 = self.ThumbColor end
			end)
			scrollThumbFrame.InputBegan:Connect(function(input)
				if input.UserInputService ~= Enum.UserInputService.MouseButton1 or checkMouseInGui(scrollThumb) then return end
	...
	Lib.Window = (function()
		...
		local function resizeHook(self,resizer,dir)
			...
			resizer.InputBegan:Connect(function(input)
				if not self.Dragging and not self.Resizing and self.Resizable and self.ResizableInternal then
					...
					elseif input.UserInputService == Enum.UserInputService.MouseButton1 then
						...
						mouseEvent = service.UserInputService.InputChanged:Connect(function(input)
							if self.Resizable and self.ResizableInternal and input.UserInputService == Enum.UserInputService.TouchTap then
								self:StopTweens()
			...
			resizer.InputEnded:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and self.Resizing ~= resizer then
					resizer.BackgroundTransparency = 1
				end
			end)
		end
		...
		local createGui = function(self)
			...
			guiTopBar.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.MouseButton1 and self.Draggable then
					local releaseEvent,mouseEvent
					...
					mouseEvent = cloneref(game:GetService("UserInputService")).InputChanged:Connect(function(input)
						if input.UserInputService == Enum.UserInputService.TouchTap and self.Draggable and not self.Closed then
			...
			guiMain.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.MouseButton1 and not self.Aligned and not self.Closed then
					moveToTop(self)
				end
			end)
		...
		local function sideResizerHook(resizer,dir,side,pos)
			...
			resizer.InputEnded:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and side.Resizing ~= resizer then
					resizer.BackgroundColor3 = theme.Button
				end
			end)
		end
	...
	Lib.ContextMenu = (function()
		...
		funcs.Show = function(self,x,y)
			...
			self.CloseEvent = service.UserInputService.InputBegan:Connect(function(input)
				if not closable or input.UserInputService ~= Enum.UserInputService.MouseButton1 then return end
	...
	Lib.CodeFrame = (function()
		...
		funcs.ConnectEditBoxEvent = function(self)
			...
			self.EditBoxEvent = service.UserInputService.InputBegan:Connect(function(input)
				if input.UserInputService ~= Enum.UserInputService.Keyboard then return end
	...
	Lib.Checkbox = (function()
		...
		local function initGui(self,frame)
			...
			checkbox.InputBegan:Connect(function(i)
				if i.UserInputService == Enum.UserInputService.MouseButton1 then
					local release
	...
	Lib.BrickColorPicker = (function()
		...
		local function hexInput(self,hex,color)
			hex.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.MouseButton1 and isMouseInHexagon(hex) then
			...
			hex.InputChanged:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.TouchTap and isMouseInHexagon(hex) then
	...
	Lib.ColorPicker = (function() -- TODO: Convert to newer class model
		...
		local function new()
			...
			okButton.InputBegan:Connect(function(input) if input.UserInputService == Enum.UserInputService.TouchTap then okButton.BackgroundTransparency = 0.4 end end)
			okButton.InputEnded:Connect(function(input) if input.UserInputService == Enum.UserInputService.TouchTap then okButton.BackgroundTransparency = 0 end end)

			cancelButton.MouseButton1Click:Connect(function() newMt.OnCancel:Fire() window:Close() end)
			cancelButton.InputBegan:Connect(function(input) if input.UserInputService == Enum.UserInputService.TouchTap then cancelButton.BackgroundTransparency = 0.4 end end)
			cancelButton.InputEnded:Connect(function(input) if input.UserInputService == Enum.UserInputService.TouchTap then cancelButton.BackgroundTransparency = 0 end end)
	...
	Lib.NumberSequenceEditor = (function()
		local function new() -- TODO: Convert to newer class model
			...
			envelopeDragTop.InputBegan:Connect(function(input)
				if input.UserInputService ~= Enum.UserInputService.MouseButton1 or not currentPoint or Lib.CheckMouseInGui(currentPoint[4].Select) then return end
				local mouseEvent,releaseEvent
			...
			local function placePoint(point)
				...
				newSelect.InputBegan:Connect(function(input)
					...
					if input.UserInputService == Enum.UserInputService.MouseButton1 and not currentlySelected then
						currentPoint = point
						local mouseEvent,releaseEvent
			...
			local function buttonAnimations(button,inverse)
				button.InputBegan:Connect(function(input) if input.UserInputService == Enum.UserInputService.TouchTap then button.BackgroundTransparency = (inverse and 0.5 or 0.4) end end)
				button.InputEnded:Connect(function(input) if input.UserInputService == Enum.UserInputService.TouchTap then button.BackgroundTransparency = (inverse and 1 or 0) end end)
			end

			numberLine.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.MouseButton1 and #points < 20 then
	...
	Lib.ColorSequenceEditor = (function() -- TODO: Convert to newer class model
		local function new()
			...
			colorLine.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.MouseButton1 and #colors < 20 then
					local maxSize = colorLine.AbsoluteSize.X-1
					local relativeX = mouse.X - colorLine.AbsolutePosition.X
					if relativeX < 0 then relativeX = 0 end
					if relativeX > maxSize then relativeX = maxSize end
	...
	Lib.ClickSystem = (function()
		...
		funcs.Trigger = function(self,item,button)
			if table.find(self.AllowedButtons,button) then
				...
				local release
				release = service.UserInputService.InputEnded:Connect(function(input)
					if input.UserInputService == Enum.UserInputService["MouseButton"..button] then
						release:Disconnect()
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Ultimate Debugging Suite. Added mobile support by lo2z",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		if not val then
			...
			Main.MainGuiMouseEvent = service.UserInputService.InputBegan:Connect(function(input)
				if input.UserInputService == Enum.UserInputService.MouseButton1 and not Lib.CheckMouseInGui(Main.MainGui.OpenButton) and not Lib.CheckMouseInGui(Main.MainGui.OpenButton.MainFrame) then
